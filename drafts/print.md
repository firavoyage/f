...
U.M.R Has Something to Record🍥🛠, [3/25/26 2:10 PM]
前段时间，派出所 给咱打了电话，问咱有没有买过 无人机。
咱：没有，家里人也没有。
派出所：彳亍。如果你买了无人机，记得去 UOM 平台实名登记。

据说派出所会根据网购平台购买记录筛查目标。咱翻了翻某东和某宝，还真发现了几条购买记录：
「三星内存卡256G TF卡 microsd卡大疆相机无人机高速Switch存储卡……」
「2/3串3.7V快充锂电池均衡无人机充电模块大功率……」
警察同志，您多虑了，这种东西可不会飞（）
...
有人吐槽AI提示词技巧，已经到要用指定词，首单词字母大写这种程度，已经都和巫师咒语差不多了。

感觉确实如此，以前提示词技巧还是很符合人类直觉的。
就像定义是专家，所以能力更强，谁都能认为很合理。
甚至早期谁都能发表一下自己提示词技巧。

但是模型进步，很多技巧已经不需要的同时，已经开始不符合人类直觉了。
就像被吐槽的如果不让模型用“接住”，它会换着花样用托住，承接来继续说，让人感觉不像人。

当然这也被研究过，反例无效原理。但是它和人类直觉就没什么关系了，单纯考虑的是概率模型本身。
AI回复是从概率最高的几个词里选，如果用提示词抑制最高的这个词的概率，由于AI并没有自动根据语义抑制相关词的概率的功能，它只会选用另一个差不多的词。

所以说到了现在这样，如果说和咒语有相似之处也没什么毛病。
普通人按直觉写非提供信息类的提示词已经比较难得到想要的结果，毕竟好内化的都被训练过了不需要写。

---

总感觉 vibe coding 以后我有点不敢自己修改已经让 ai 维护了一段时间的代码
首先文档什么的都是 ai 自动帮忙维护，还有就是经常遇到有一个需求先想出完整方案让 ai 实施后，如果有些小的细节我不满意，我就会想自己改
但是我要是自己改之后，如果要接着用这段对话的上下文做其他事情，又得和它说我改了什么和为什么改那些地方……感觉这种事情次数一多就会有点头疼（（
果然还是不喜欢工作交接x
...
今天把新的想法加入 project backlog 的时候发现里面有一百项了，有一百个想做但是没时间做的想法了... 是值得庆祝的事情吗？

成年人就是这样的（没关系再过几年你就会发现有些事情因为永远无法实现可以划掉了）
...
幻想作品中不同寿命和世界观的生物,对于庆祝和节日不同才比较真实. 
也是常见用于描述双方差异点的地方, 毕竟一个千年生命每年庆祝一次自然很奇怪.

不过由于现实基本没有这种长命种,甚至连无生命的组织也没有这么长的寿命,实际上看不到这种案例.
但是存活时间短的倒是很多, 不过能意识到这一点并且好意思调整庆祝频率的不多.
比较常见的大概就是某些游戏会发开服30天,100天,200天纪念礼.
另外就是vtb了, 7天开播纪念都来了, 不过考虑人均活动时间其实也能理解.
...
f, [4/8/26 8:28 PM]
好的，这次重构终于要接近尾声了，其实感觉 ai 意外的在重构这件事情上非常保守，review 的时期候经常能出现架构虽然是新的，但是有些数据的对类依赖关系还是旧的，然后就出现了一些抽象的 bug（感觉今天终于能修完了（趴

f, [4/8/26 8:28 PM]
今天看到我们有个工具需要 npm 安装依赖，但是我们内网服务器没法用 npm
于是解决方案就是把 node_modules 上传到工具的内网的源码仓库里，这样有人用的话，拉下来能直接用了（（
但是我没有在内网服务器的部署，刚才 git pull 的时候吓了我一跳x

---

最近刷到坊洛病情恶化的消息，总感觉这个名字好熟悉…突然想起来，在 OI Wiki 群里好像看到过，于是去翻相册…

那是 22 年元旦的周末，当时看到她加群，感觉坊洛这个名字好好听（这么可爱的名字在 OI 圈不常见的）一看头像也很可爱，就截了图留念…
还想着，这么可爱什么时候能有机会认识呢…
