...
network inspection does not seem easy. ytdlp fails (with). (whether outdated apt or lastest pip, whether proxy node). record screen is last resort (i dont wanna do this since the vid is not really high quality.).
