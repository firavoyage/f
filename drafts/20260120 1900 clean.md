...
<!-- 2026.01.21 i tweaked the fold level... maybe clean is not the essence of friction. but i still think headings are for structure (book chapters, not list items). not for a list. esp when you want to be quiet and graceful. and llms wont know by default (propmt engineering is complex. simple things might be right. complex things could not, even if working.). -->
