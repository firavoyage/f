...
<mark style="font-family: &quot;Google Sans&quot;, Roboto, Arial, sans-serif; font-size: 16px; font-weight: 500; margin: 0px; text-decoration: none solid rgb(230, 232, 240); border-bottom: 0px none rgb(230, 232, 240);"><span style="font-family: &quot;Google Sans&quot;, Roboto, Arial, sans-serif; font-size: 16px; font-weight: 500; margin: 0px; text-decoration: none solid rgb(230, 232, 240); border-bottom: 0px none rgb(230, 232, 240);">Yes, you can write a userscript to disable JavaScript or block website interference when you press</span></mark> `Ctrl + C`. \[[1](https://www.codingnepalweb.com/disable-right-click-and-copy-paste-javascript/)]

However, userscripts cannot toggle the browser's global JavaScript engine. Instead, your userscript must intercept and neutralize the specific scripts websites use to block copying. \[[1](https://www.enablejavascript.io/en/how-to-disable-javascript-on-google-chrome)]

### How It Works

Websites block copying by listening for events like `copy`, `contextmenu`, `keydown`, or `mouseup` and calling `preventDefault()`. Your userscript will listen for `Ctrl + C` first and stop those website scripts from running. \[[1](https://www.reddit.com/r/firefox/comments/dp9xuh/is%5Fthere%5Fa%5Fway%5Fto%5Flimit%5Fwhat%5Fjavascript%5Fcan%5Fdo%5Fin/), [2](https://phppot.com/javascript/disable-mouse-right-click-cut-copy-paste/), [3](https://en-ca.wordpress.org/plugins/tags/disable-right-click/), [4](https://support.google.com/chrome/thread/13407373/how-can-i-disable-annoying-ctrl-c-scripts?hl=en)]
...
4. Copy your text.
5. Repeat the steps and type **Enable JavaScript** to turn it back on. \[[1](https://www.analyticsmania.com/post/how-to-pause-javascript-and-inspect-an-element-that-quickly-disappears/), [2](https://www.impressivewebs.com/how-to-disable-javascript-in-almost-any-browser/), [3](https://community.spiceworks.com/t/how-to-turn-off-javascript-in-google-chrome/1078156), [4](https://developer.chrome.com/docs/devtools/javascript/disable), [5](https://www.janbasktraining.com/community/java/how-to-disable-javascript-in-chrome-developer-tools)]
...
- [link](https://www.codingnepalweb.com/disable-right-click-and-copy-paste-javascript/)\
  ...
  Oct 21, 2022 — In this blog, you'll learn how to easily block users from doing these actions by disabling the mouse right click and the shortcut ...\
  \
  \
  CodingNepal
...
- [link](https://www.enablejavascript.io/en/how-to-disable-javascript-on-google-chrome)\
  ...
  May 5, 2026 — Disable JavaScript globally in Chrome ( Google Chrome ) (Windows, Mac, Linux, Chromebook) The same toggle exists on every desktop ...\
  \
  \
  enablejavascript.io
...
- [link](https://www.reddit.com/r/firefox/comments/dp9xuh/is%5Fthere%5Fa%5Fway%5Fto%5Flimit%5Fwhat%5Fjavascript%5Fcan%5Fdo%5Fin/)\
  ...
  Oct 30, 2019 — Stop JavaScript from using/accessing keyboard key events completely (e.g. "keydown" events, scripts intercepting keyboard keys and...\
  \
  \
  Reddit
...
The website is likely using a `copy` event listener to modify the DOM (such as injecting tracking links, copyright notices, or hidden text) right before the browser reads the clipboard, and then reverting it immediately after. \[[1](https://cside.com/blog/government-and-university-websites-targeted-in-scriptapi-dev-client-side-attack)]
...
### The Solution: Intercept the Selection and Clipboard \[[1](https://superuser.com/questions/389410/how-can-i-stop-javascript-from-modifying-the-clipboard)]

Instead of blocking keys, the cleanest fix is to intercept the `copy` event at the highest level (the capture phase), stop the website's mutation script from firing, and manually force the clean, highlighted text into your clipboard. \[[1](https://medium.com/@smritirastogi33/javascript-basics-to-mastery-part-7-cb9ecefef5c)]
...
- Does this script **successfully bypass** the issue on the target page? \[[1](https://www.sophos.com/en-us/blog/technical-analysis-cve-2020-15654-and-a-history-of-firefox-browser-lock-bugs)]
...
- [link](https://cside.com/blog/government-and-university-websites-targeted-in-scriptapi-dev-client-side-attack)\
  ...
  Jan 21, 2025 — The Script's Mechanism: \*\*Retrieve the script tag:\*\*Using document. currentScript, the malicious script identifies its location in...\
  \
  \
  cside.com
...
- [link](https://superuser.com/questions/389410/how-can-i-stop-javascript-from-modifying-the-clipboard)\
  ...
  Feb 13, 2012 — Are you pressing \[Ctrl]+\[C] to copy? The system's copy hotkey may be getting intercepted by JavaScript and setting Selecton + Junk...\
  \
  \
  Super User
...
- [link](https://medium.com/@smritirastogi33/javascript-basics-to-mastery-part-7-cb9ecefef5c)\
  ...
  Aug 9, 2023 — From there the capturing phase starts. 1. Capturing phase: In this phase, the event is triggered on the highest-level element in t...\
  \
  \
  Medium
...
Websites can intercept events ahead of your userscript using a few advanced methods. \[[1](https://www.cs.uct.ac.za/mit%5Fnotes/web%5Fprogramming/html/ch15.html)]
...
- **Inline Event Handlers**: HTML attributes like execute incredibly early in the browser cycle.
- **Event Overriding**: The site might overwrite `window.addEventListener` entirely to block other scripts from registering listeners. \[[1](http://www.softwareishard.com/blog/firebug/firebug-2-support-for-dynamic-scripts/), [2](https://gist.github.com/3944bba7befd6868d661414111abf87f), [3](https://stackoverflow.com/questions/39582108/sending-messages-to-page-javascript-from-a-content-script)]
...
- **Prototype Monkeypatching**: By hijacking `EventTarget.prototype.addEventListener`, your script intercepts the website's code when it tries to set up the copy block, throwing the site's listener in the trash before it can ever fire. \[[1](https://github.com/Tampermonkey/tampermonkey/issues/344)]
...
- [link](http://www.softwareishard.com/blog/firebug/firebug-2-support-for-dynamic-scripts/)\
  ...
  Mar 27, 2014 — Inline Event Handlers Inline event handlers are little pieces of JavaScript placed within HTML attributes designed to handle basic...\
  \
  \
  Software is hard
...
To capture the actual HTML formatting—including styles, structure, and images—just like an MHTML or browser copy, you must grab both the **plain text** and the **HTML source** of your selection. \[[1](https://superuser.com/questions/547773/how-do-i-copy-paste-website-content-with-formatting)]

You can inject both formats into the clipboard simultaneously using `e.clipboardData.setData()`. \[[1](https://forum.literatureandlatte.com/t/copy-as-html-not-retaining-italics-or-bold/149582)]
...
- **`range.cloneContents()`**: This clones the actual underlying DOM nodes you highlighted, preserving tags like , , , and .
...
- Are **embedded styles/images** displaying correctly after you paste? \[[1](https://langui.net/copy-as-html/)]
...
- [link](https://superuser.com/questions/547773/how-do-i-copy-paste-website-content-with-formatting)\
  ...
  Feb 7, 2013 — Well, Chrome ( Google Chrome ) , or any modern browser, when copying your selection, will always copy the HTML (i.e., with formatt...\
  \
  \
  Super User
...
- [link](https://forum.literatureandlatte.com/t/copy-as-html-not-retaining-italics-or-bold/149582)\
  ...
  Aug 1, 2025 — But it would be very easy to have both clipboards, the plain text (made of html) as it is now, and the html type too (same content...\
  \
  \
...
- [link](https://langui.net/copy-as-html/)\
  ...
  Apr 23, 2014 — Copy as HTML allows you to copy HTML from Safari and other Webkit-based apps and paste it into browsers such as Firefox, Opera and...\
  \
  \
  Langui.net